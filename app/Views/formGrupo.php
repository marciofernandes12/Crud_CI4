...
<div class="container">
    ...
    <form method="post" action="<?= base_url('/form-grupo') ?>">
        <div class="mb-3">
            <label for="nomeGrupo" class="form-label">Nome</label>
            <input type="text" class="form-control" id="nomeGrupo" name="nomeGrupo" placeholder="Digite o nome do grupo"
                   required>
        </div>
        <div class="mb-3">
            <label for="descGrupo" class="form-label">Descrição</label>
            <textarea class="form-control" id="descGrupo" name="descGrupo" placeholder="Digite a descrição do grupo"
                      requireda></textarea>
        </div>
